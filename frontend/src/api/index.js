...
export const pipelineApi = {
  ...
  status: (period_start, period_end) =>
    api
      .get(`/pipeline/status/${period_start}/${period_end}`)
      .then((r) => r.data),
};
...
export const attendanceApi = {
  summary: (period_start, period_end) =>
    api
      .get("/attendance", { params: { period_start, period_end } })
      .then((r) => r.data),
...
export const leaveApi = {
  summary: (period_start, period_end) =>
    api
      .get("/leave", { params: { period_start, period_end } })
      .then((r) => r.data),
  forEmployee: (empCode, period_start, period_end) =>
    api
      .get(`/leave/${empCode}`, { params: { period_start, period_end } })
      .then((r) => r.data),
};
...
export const flagsApi = {
  ...
  resolve: (flagId) =>
    api.patch(`/flags/${flagId}/resolve`).then((r) => r.data),
  recompute: (period_start, period_end) =>
    api
      .post("/flags/recompute", { period_start, period_end })
      .then((r) => r.data),
};
...
export const emailApi = {
  ...
  createTemplate: (payload) =>
    api.post("/email/templates", payload).then((r) => r.data),
  ...
  send: (flag_ids, template_id, preview_only = false) =>
    api
      .post("/email/send", { flag_ids, template_id, preview_only })
      .then((r) => r.data),
...
export const analyticsApi = {
  overview: (period_start, period_end) =>
    api
      .get("/analytics/overview", { params: { period_start, period_end } })
      .then((r) => r.data),
  attendanceChart: (period_start, period_end) =>
    api
      .get("/analytics/attendance-chart", {
        params: { period_start, period_end },
      })
      .then((r) => r.data),
  flagDistribution: (period_start, period_end) =>
    api
      .get("/analytics/flag-distribution", {
        params: { period_start, period_end },
      })
      .then((r) => r.data),
